...
public class TravelAccountLookup
{
    ...
    public string TravelPurposeCode { get; set; } = string.Empty;
    public string Destination { get; set; } = string.Empty; // I -> InState; O -> OutOfState/Domestic; F -> Foreign/International
